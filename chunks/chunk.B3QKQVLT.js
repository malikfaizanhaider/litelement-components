  ...
  reportValidity() {
    if (!this.inline && this.input.invalid) {
      return new Promise((resolve) => {
        this.dropdown.addEventListener("i2c-after-show", () => {
  ...
  render() {
      ...
      "color-picker__copy-feedback--dark": this.lightness > 50
        ...
        <div class="color-picker__user-input">
          ...
          ${!this.noFormatToggle ? T`
                <i2c-button exportparts="base:format-button" size="small" @click=${this.handleFormatToggle}>
    ...
    return T`
      <i2c-dropdown
        ...
        ?disabled=${this.disabled}
        ?hoist=${this.hoist}
        @i2c-after-hide=${this.handleDropdownAfterHide}
      >
        <button
          part="trigger"
          slot="trigger"
...
I2CColorPicker.styles = r(color_picker_default);
__decorateClass([
  o('[part="input"]')
], I2CColorPicker.prototype, "input", 2);
__decorateClass([
  o('[part="preview"]')
], I2CColorPicker.prototype, "previewButton", 2);
__decorateClass([
  o(".color-dropdown")
], I2CColorPicker.prototype, "dropdown", 2);
__decorateClass([
  r2()
], I2CColorPicker.prototype, "inputValue", 2);
__decorateClass([
  r2()
], I2CColorPicker.prototype, "hue", 2);
__decorateClass([
  r2()
], I2CColorPicker.prototype, "saturation", 2);
__decorateClass([
  r2()
], I2CColorPicker.prototype, "lightness", 2);
__decorateClass([
  r2()
], I2CColorPicker.prototype, "alpha", 2);
__decorateClass([
  r2()
], I2CColorPicker.prototype, "showCopyFeedback", 2);
__decorateClass([
  e()
], I2CColorPicker.prototype, "value", 2);
__decorateClass([
  e()
], I2CColorPicker.prototype, "format", 2);
__decorateClass([
  e({ type: Boolean, reflect: true })
], I2CColorPicker.prototype, "inline", 2);
__decorateClass([
  e()
], I2CColorPicker.prototype, "size", 2);
__decorateClass([
  e({ attribute: "no-format-toggle", type: Boolean })
], I2CColorPicker.prototype, "noFormatToggle", 2);
__decorateClass([
  e()
], I2CColorPicker.prototype, "name", 2);
__decorateClass([
  e({ type: Boolean, reflect: true })
], I2CColorPicker.prototype, "disabled", 2);
__decorateClass([
  e({ type: Boolean, reflect: true })
], I2CColorPicker.prototype, "invalid", 2);
__decorateClass([
  e({ type: Boolean })
], I2CColorPicker.prototype, "hoist", 2);
__decorateClass([
  e({ type: Boolean })
], I2CColorPicker.prototype, "opacity", 2);
__decorateClass([
  e({ type: Boolean })
], I2CColorPicker.prototype, "uppercase", 2);
__decorateClass([
  e({ attribute: false })
], I2CColorPicker.prototype, "swatches", 2);
__decorateClass([
  watch("format")
], I2CColorPicker.prototype, "handleFormatChange", 1);
__decorateClass([
  watch("opacity")
], I2CColorPicker.prototype, "handleOpacityChange", 1);
__decorateClass([
  watch("value")
], I2CColorPicker.prototype, "handleValueChange", 1);
I2CColorPicker = __decorateClass([
  n("i2c-color-picker")
], I2CColorPicker);
var color_picker_default2 = I2CColorPicker;
